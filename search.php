					...
					<div class="innerWrapper-2">
						...
						if ( have_posts() ):
							...
							<div class="result-bar page-header d-none">
								<h1 class="page-title"><?php esc_html_e( 'Search Results For:', 'ausiran' );?> <?php print get_search_query();?></h1>
							</div>
							<?php
							...
							<div class="basic-pagination mb-40 pagination justify-content-left">
								<?php ausiran_pagination( '<i class="fal fa-arrow-left"></i>', '<i class="fal fa-arrow-right"></i>', '', ['class' => ''] );?>
							</div>
						<?php
						else:
